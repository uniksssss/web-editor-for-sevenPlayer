...
export const StatisticTemplate = forwardRef<
  HTMLDivElement,
  StatisticTemplateProp
>(
  (
    {
      mainHomeScore,
      ...
      <div className="template-wrapper">
        <div className="template matchday" ref={ref}>
          ...
          <div className="statistic_logos">
            {homeLogo && (
              <img src={homeLogo} alt="" className="statistic_logo_home" />
            )}
            {awayLogo && (
              <img src={awayLogo} alt="" className="statistic_logo_away" />
            )}
          </div>
