...
export const ScoreTemplate = forwardRef<HTMLDivElement, ScoreTemplateProp>(
  (
    { mainHomeScore, mainAwayScore, extraScore, photo, homeLogo, awayLogo },
    ref
  ) => {
    ...
    return (
      <div className="template-wrapper">
        <div className="template matchday" ref={ref}>
          {photoUrl && (
            <img src={photoUrl} alt="" className="score-player-photo" />
          )}
          <img src={scoreTemplate} alt="" className="background" />
          <div className="score_logos">
            {homeLogo && (
              <img src={homeLogo} alt="" className="score_logo_home" />
            )}
            {awayLogo && (
              <img src={awayLogo} alt="" className="score_logo_away" />
            )}
          </div>
          <div className="score">
