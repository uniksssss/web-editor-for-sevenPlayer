...
const playerPhotos = [
  { id: "tica", name: "Тица", path: "/src/assets/players/Tica.png" },
  {
    id: "kushniruk",
    name: "Кушнирук",
    path: "/src/assets/players/kushniruk.png",
  },
  { id: "snip", name: "Шнип", path: "/src/assets/players/Snip.png" },
  {
    id: "sokolova",
    name: "Соколова",
    path: "/src/assets/players/Sokolova.png",
  },
  {
    id: "bessonova",
    name: "Бессонова",
    path: "/src/assets/players/Bessonova.png",
  },
  {
    id: "voropaeva",
    name: "Воропаева",
    path: "/src/assets/players/Voropaeva.png",
  },
  {
    id: "cernyseva",
    name: "Чернышева",
    path: "/src/assets/players/Cernyseva.png",
  },
  {
    id: "protopopova",
    name: "Протопопова",
    path: "/src/assets/players/Protopopova.png",
  },
  {
    id: "shelkovkina",
    name: "Шелковкина",
    path: "/src/assets/players/shelkovkina.png",
  },
  {
    id: "musienko",
    name: "Мусиенко",
    path: "/src/assets/players/Musienko.png",
  },
  {
    id: "psenicyna",
    name: "Пшеницына",
    path: "/src/assets/players/Psenicyna.png",
  },
  ...
  { id: "demesok", name: "Демешок", path: "/src/assets/players/Demesok.png" },
  {
    id: "nikitina",
    name: "Никитина",
    path: "/src/assets/players/Nikitina.png",
  },
  {
    id: "hlebnikova",
    name: "Хлебникова",
    path: "/src/assets/players/Hlebnikova.png",
  },
  ...
  { id: "pavlova", name: "Павлова", path: "/src/assets/players/Pavlova.png" },
  {
    id: "vaganova",
    name: "Ваганова",
    path: "/src/assets/players/Vaganova.png",
  },
  { id: "svydkaa", name: "Швыдкая", path: "/src/assets/players/Svydkaa.png" },
  {
    id: "fitisova",
    name: "Фитисова",
    path: "/src/assets/players/Fitisova.png",
  },
